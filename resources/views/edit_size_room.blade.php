    ...
    <div class="shadow mt-3 d-flex py-3" style="border-radius: 18px; width: 100%; height: 85vh;"> {{-- ถ้าต้องการให้หน้าจอ overflow ได้ให้ปรับ height: 100%; --}}
        <div class="container">
            ...
            <div class="d-flex align-items-end justify-content-end" style="padding-top: 23%">
                <button type="button" class="btn me-3 btn-secondary shadow" style="width: 15%; height: 15%; border-radius: 10px;">ย้อนกลับ</button>
                <button type="button" class="btn shadow" style="width: 15%; height: 15%; border-radius: 10px; background-color: #000C6A; color: #ffffff">บันทึก</button>
            </div>
        </div>
    </div>
@endsection
