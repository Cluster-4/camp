        ...
        <div class="shadow container" style="background-color :#ffffff;">
            <div class="table-wrapper">
                <div class="search" style="position: relative">
                    ...
                    <svg style="font-size: 20px; color:black; position:absolute; top:23px; margin-left:8px" width="25"
                        height="22" viewBox="0 0 30 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    <select name="cars" id="cars" class="shadow Status "style=" padding-left: 40px ">
                        ...
                        <option value="volvo">ผู้ใช้ทั่วไป</option>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody class="text-center ">
                        <tr>
                            ...
                            <td>
                                <a href="/edit_account" class="edit" title="เเก้ไข" data-toggle="tooltip">
